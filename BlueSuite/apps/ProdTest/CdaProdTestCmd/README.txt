...
CHG:BUD-DETECT:
Tests the microswitches used to detect the presence of earbuds in the charger case.
The GPIOs used and the test sequence are defined by the "BudDetect*" settings.
