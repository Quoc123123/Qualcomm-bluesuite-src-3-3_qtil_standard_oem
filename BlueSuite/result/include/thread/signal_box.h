...
//
//  $Id: //depot/hosttools/source_releases/BlueSuite/BlueSuite.SRC.3.3/SRC/BlueSuite/result/include/thread/signal_box.h#1 $
//
///////////////////////////////////////////////////////////////////////
...
protected:
    ...
    // This will form a linked list of all Item's in a Box.
    Item*       m_next;
};
